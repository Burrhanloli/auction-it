    ...
    <PublicAuctionGuard auction={auction}>
      <LazyMotion features={domAnimation}>
        <div className="relative flex min-h-screen flex-col overflow-hidden bg-neutral-950 font-sans text-white">
          {/* Header */}
          <header
            className={`relative sticky top-0 z-40 flex flex-col justify-between gap-4 border-b border-[#3c3c3c] bg-neutral-950 px-4 py-4 transition-transform duration-300 ease-in-out md:flex-row md:items-center md:gap-0 md:px-6 ${
          ...
          >
            ...
            <Link to="/auction/$auctionId/live" params={{ auctionId }}>
              <button
                type="button"
                className="flex cursor-pointer items-center justify-center gap-x-2 rounded-none border border-white bg-white px-4 py-2 text-xs font-bold tracking-[1.5px] text-black uppercase hover:bg-neutral-950 hover:text-white"
              >
...
export function TopValuedPlayers({ soldPlayers, auction }: { soldPlayers: any[]; auction: any }) {
  return (
    <>
      {/* SECTION 1: HIGHEST VALUED PLAYERS (TOP RANKINGS) */}
      <div>
        <div className="mb-8 flex items-center">
          <AwardIcon className="mr-3 size-5 text-white" />
        ...
        <div className="overflow-hidden rounded-none border border-[#3c3c3c] bg-[#1a1a1a]">
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-left text-xs">
              <thead>
                <tr className="border-b border-[#3c3c3c] bg-neutral-950 text-[10px] font-bold tracking-[1.5px] text-[#bbbbbb] uppercase">
                    ...
                    rank === 1
                      ...
                      : rank === 2
                        ...
                        : rank === 3
                          ...
                          : "bg-neutral-950 text-[#bbbbbb] border border-[#3c3c3c]";
                  ...
                  return (
                    ...
                    >
                      <td className="px-6 py-4 text-center">
                        <span
                          className={`inline-flex size-6 items-center justify-center rounded-none border border-[#3c3c3c] text-[10px] ${rankStyle}`}
                        >
                          {rank}
                        </span>
                      </td>
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-x-2">
                          {player.imageUrl ? (
                            ...
                            <div className="flex size-8 items-center justify-center rounded-none border border-[#3c3c3c] bg-neutral-950 text-[10px] font-bold text-[#bbbbbb]">
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-block rounded-none border border-[#3c3c3c] bg-neutral-950 px-2.5 py-0.5 text-[9px] font-bold tracking-[1.5px] text-[#bbbbbb] uppercase`}
                        >
                        ...
                        <div className="flex items-center gap-x-2">
                          {buyerTeam?.logoUrl ? (
                            <ImageViewer
                              ...
                              alt={buyerTeam.name}
                              className="size-6 rounded-none border border-[#3c3c3c] bg-neutral-950 object-contain"
                            />
                          ) : (
                            <div className="flex size-6 items-center justify-center rounded-none border border-[#3c3c3c] bg-neutral-950 text-[9px] font-black text-[#bbbbbb]">
                ...
                {soldPlayers.length === 0 && (
                  <tr>
                    <td colSpan={5} className="py-12 text-center font-medium text-[#bbbbbb]">
                      No players have been purchased yet in this arena. Bids will stream here live.
                    </td>
                  </tr>
                )}
              </tbody>
...
export function TeamStandings({ auction }: { auction: any }) {
  return (
    <>
      {/* SECTION 2: TEAM STANDINGS OVERVIEW */}
      <div>
        <div className="mb-8 flex items-center">
          <DollarSignIcon className="mr-3 size-5 text-white" />
          <div className="inline-flex flex-col">
            <MStripeDivider className="mb-2 w-full" />
            <h2 className="text-xl font-black tracking-[1.5px] text-white uppercase">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {auction.teams?.map((team: any) => {
            ...
            const percentSpent = Math.min(100, Math.round((spentBudget / team.totalBudget) * 100));
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-y-4 p-6">
                  ...
                  <div className="grid grid-cols-1 gap-3 rounded-none border border-[#3c3c3c] bg-neutral-950 p-3 sm:grid-cols-2">
                    {/* Owner Column */}
                    <div className="flex items-center gap-x-2">
                      {team.ownerImageUrl ? (
                        <LazyImage
                          ...
                          className="size-7 shrink-0 rounded-none border border-[#3c3c3c] bg-[#1a1a1a] object-contain"
                        />
                      ) : (
                        <div className="flex size-7 shrink-0 items-center justify-center rounded-none border border-[#3c3c3c] bg-[#1a1a1a] text-[10px] text-[#bbbbbb]">
                          👤
                        </div>
                      )}
                    ...
                    {/* Captain Column */}
                    <div className="flex items-center gap-x-2 border-l border-[#3c3c3c] pl-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-center justify-between text-[10px] font-bold text-[#bbbbbb] uppercase">
                      ...
                      <span className="font-black text-white">{team.remainingBudget} pts left</span>
                    </div>
                  </div>
                          ...
                          <div
                            ...
                            className={`flex items-center justify-between rounded-none border ${
                              isCaptain
                                ...
                                : "border-[#3c3c3c] bg-neutral-950"
                            } p-2 text-xs transition-colors`}
                          >
                            <div className="flex items-center gap-x-2 truncate pr-2">
                              <span
                              ...
                              {isCaptain && (
                                <span className="flex items-center gap-x-2 rounded-none bg-white px-1 py-0.5 text-[8px] font-black tracking-wider text-black uppercase">
                                  <StarIcon className="size-2.5 fill-black" />
                                  <span>C</span>
                                </span>
                              )}
                            </div>
