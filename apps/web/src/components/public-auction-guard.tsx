    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-neutral-950 p-6 text-[#bbbbbb]">
        ...
        <Link to="/">
          <button
            type="button"
            className="cursor-pointer rounded-none border border-white bg-white px-4 py-2 text-xs font-bold tracking-[1.5px] text-black uppercase hover:bg-neutral-950 hover:text-white"
          >
            Back to Dashboard
          </button>
        </Link>
